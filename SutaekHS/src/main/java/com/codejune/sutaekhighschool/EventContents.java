...
public class EventContents extends ActionBarActivity {

    TextView tvTitle, tvDate, tvAuthor, tvContents, tvFile;
    CardView cvFile;
    String cons = "", filename = "", img="";
        ...
        protected String doInBackground(String... urls) {
            ...
            if (!urls[0].equals("")) {
                ...
                try {
                    ...
                    Elements rawfile = doc.select("#bbsWrap div table tbody tr:eq(5) td img");
                    ...
                    for (Element el : rawfile) {
                        String imgdata = "http://www.sutaek.hs.kr/" + el.attr("src");
                        img = filename + "<img src=\"" + imgdata + "\">";
                        //String con = el.text();
                        //con = con.trim();
                        Log.d("CONS2", imgdata);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.webview_menu:
                Intent in = getIntent();
                Intent intent = new Intent(EventContents.this,
                        WebViewActivityEvent.class);
