...
public class SchoolEvent extends Activity {
                ...
                public void run() {
                    ...
                    mHandler.post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            progressDialog = ProgressDialog.show(SchoolEvent.this,
                                    "", loading, true);
                        }
                    });
                    ...
                    try {
                        ...
                        Document doc = Jsoup
                                .connect(
                                        "http://www.sutaek.hs.kr/main.php?menugrp=020400&master=bbs&act=list&master_sid=3")
                                .get();
                    ...
                    mHandler.post(new Runnable() {
                        public void run() {
                            ...
                            // UI Task
                            adapter = new ArrayAdapter<String>(SchoolEvent.this,
